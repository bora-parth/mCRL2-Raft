...
for file in "${files[@]}"; do
    session_name="${file%.*}_crash_11" # Extract the session name without the file extension
    ...
    tmux send-keys -t "$session_name" "lps2pbes -v raft_AC_11.lps -f $file raft_$session_name.pbes" Enter
